 ...
 * This interface refines the {@link WeigthedGraph} interface to associate each
 * edge with an orientation.  Edges between the same two vertices but with
 * different orientations are distinct for this class.
 *
...
public interface WeightedDirectedGraph  {
     ...
     * edge
     */
    Set<? extends WeightedDirectedEdge> inEdges(int vertex);
     ...
     */
    Set<? extends WeightedDirectedEdge> outEdges(int vertex);    
     ...
     */
    Set<? extends WeightedDirectedEdge> edges();

    /**
     * Returns the set of edges connected to the provided vertex.
     */
    Set<? extends WeightedDirectedEdge> getAdjacencyList(int vertex);
    
    /**
     * {@inheritDoc}
     */
    WeightedDirectedGraph subgraph(Set<Integer> vertices);
