...
public class DependencyContextExtractor implements ContextExtractor {
  ...
  /**
   * The {@link DependencyContextGenerator} responsible for processing a {@link
  ...
  /**
   * Returns the string for the context header.  If {@link readHeader} is true,
   * this returns the first line, otherwise it returns {@code null}.
   */
