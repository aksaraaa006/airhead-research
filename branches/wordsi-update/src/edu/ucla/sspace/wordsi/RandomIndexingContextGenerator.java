...
public class RandomIndexingContextGenerator implements ContextGenerator {
   ...
   *
   * @param indexMap The map responsible for mapping co-occurring terms to their
   *        index vectors.  This map should generate index vectors for words
   *        that are not currently mapped when in normal mode.
