 ...
 */
class ViewIntAsDoubleSparseVector extends ViewIntAsDoubleVector
                                  implements SparseVector, Serializable  {

    private static final long serialVersionUID = 1L;

    /**
     * The actual vector this {@code ViewIntAsDoubleSparseVector} is
     * decorating.
     */
    ...
    /**
     * Create a new {@code ViewIntAsDoubleSparseVector} around an already
     * existing {@code Vector} providing read only access.
     *
     * @param v The {@code Vector} to decorate.
     */
    public ViewIntAsDoubleSparseVector(IntegerVector v) {
        this(v, 0, v.length());
    }
     ...
     *               {@code ViewIntAsDoubleSparseVector}.
     * @param length The maximum length of this {@code
     *               ViewIntAsDoubleSparseVector}.
     */
    public ViewIntAsDoubleSparseVector(IntegerVector v,
                                       int offset,
                                       int length) {
