 ...
 * implemntation found
 * <a href="http://www.tartarus.org/~martin/PorterStemmer">here</a>
 *
...
public class PorterStemmer {
    ...
    /**
     * Stem a token based on the Porter Stemmer algorithm.  If no stemming is
     * needed, this will return the original word.
     *
     * @param word The word to be stemmed.
     * 
     * @return The stem of {@code word}.
     */
    ...
    /**
     * A private implementation class of the Porter Stemmer algoritm.  This
     * is currently a massive modification of the code found 
     * <a href="http://tartarus.org/~martin/PorterStemmer/java.txt">here</a>.
     * Much of this still could be fixed so that no private class needs to be
     * instansiated, but currently a new {@code Stemmer} must be created for
     * each word that needs to be stemmed.
     *
    ...
    /**
     * A simple test main to evaluate if a term provided on the command line is
     * stemmed correctly.
     */
    public static void main(String[] args) {
        System.out.println(PorterStemmer.stem(args[0]));
    }
}
