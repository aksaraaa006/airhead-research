...
function run_ckvw_bisect_on_nsf2()
%    run_ckvw_bisect_on_id('1-3_50-50',2);
%    run_ckvw_bisect_on_id('4-5_50-50',2);
%    run_ckvw_bisect_on_id('6-7_50-50',2);
%    run_ckvw_bisect_on_id('8-9_50-50',2);
%    run_ckvw_bisect_on_id('10-13_50-50',2);
%    run_ckvw_bisect_on_id('14-15_50-50',2);
%    run_ckvw_bisect_on_id('1-3_10-90',2);
%    run_ckvw_bisect_on_id('4-5_10-90',2);
%    run_ckvw_bisect_on_id('6-7_10-90',2);
%    run_ckvw_bisect_on_id('8-9_10-90',2);
%    run_ckvw_bisect_on_id('10-13_10-90',2);
%    run_ckvw_bisect_on_id('14-15_10-90',2);
%    run_ckvw_bisect_on_id('1-3_90-10',2);
%    run_ckvw_bisect_on_id('4-5_90-10',2);
%    run_ckvw_bisect_on_id('6-7_90-10',2);
%    run_ckvw_bisect_on_id('8-9_90-10',2);
%    run_ckvw_bisect_on_id('10-13_90-10',2);
%    run_ckvw_bisect_on_id('14-15_90-10',2);
