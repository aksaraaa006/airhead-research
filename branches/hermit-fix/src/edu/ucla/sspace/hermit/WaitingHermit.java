...
/**
 * An implementation of the {@code WaitingHermit} Semantic Space model. 
 *
 * </p>
 *
 ...
 */
public class WaitingHermit implements SemanticSpace, Filterable {

    /**
     * The base prefix for all {@code WaitingHermit} properties.
     */
    public static final String PROPERTY_PREFIX =
        "edu.ucla.sspace.hermit.WaitingHermit";
    ...
    /**
     * The Semantic Space name for WaitingHermit
     */
    public static final String WAITING_HERMIT_SSPACE_NAME = 
        "waiting-hermit-semantic-space";

    /**
     * The logger used to record all output
     */
    private static final Logger HERMIT_LOGGER =
        Logger.getLogger(WaitingHermit.class.getName());
    ...
    /**
     * Create a new instance of {@code WaitingHermit} which takes ownership
     */
    public WaitingHermit(
        ...
        termContexts = new HashMap<String, List<SparseDoubleVector>>();
    }
    ...
    public String getSpaceName() {
        ...
        return WAITING_HERMIT_SSPACE_NAME + "-" + indexVectorSize + 
