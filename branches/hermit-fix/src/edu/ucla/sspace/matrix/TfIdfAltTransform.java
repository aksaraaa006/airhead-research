 ...
 */
public class TfIdfAltTransform implements AltTransform {
    ...
    /**
     * Creates an instance of {@code TfIdfAltTransform} from a {@link Matrix}.
     */
    public TfIdfAltTransform(Matrix matrix) {
        ...
        if (matrix instanceof SparseMatrix) {
            ...
            // Compute the row sums for each row and the number of columns each
            // term occurs in.
    ...
    /**
     * Creates an instance of {@code TfIdfAltTransform} from a {@code File} in
     * the format {@link Format}.
     */
    public TfIdfAltTransform(File inputMatrixFile, Format format) {
        // Initialize the statistics.
        totalDocCount = 0;
        int numRows = 0;
    ...
    /**
     * Computes the Term Frequency-Inverse Document Frequency for a given value
     * where {@code value} is the observed frequency of term {@code row} in
