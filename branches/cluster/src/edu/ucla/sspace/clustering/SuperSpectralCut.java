...
public class SuperSpectralCut extends BaseSpectralCut {
    ...
    protected DoubleVector computeSecondEigenVector(Matrix matrix,
       ...
       // Compute pi, and D.  Pi is the normalized form of rho.  D a diagonal
        ...
        // Create the second largest eigenvector of the a scaled form of the row
        // normalized affinity matrix.  The computation is using the power
        // method such that the affinity matrix is never explicitly computed.
